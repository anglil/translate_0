...
// the json object that has all the attention matrices and texts
...
const WIDTH = 2000;
const HEIGHT = attention.inp_out.bot_text.length * BOXHEIGHT * 2 + 2000;//+100
...
function visualize() {
  var num_heads = attention['inp_out']['att'][0].length;
